...
public class GameMain extends JPanel implements MouseListener{
	...
	// the current game state, the enumeration 'GameState' is also created
	private GameState currentState; 
	
	// the current player, the enumeration 'Player' is also created
	...
	public GameMain() {   
	    ...
	    // Call the addMouseListener() method
		...
		// Call the constructor Board()
		board = new Board();
		
		// TODO: call the method to initialise the game board
		// Call the constructor initGame()
		initGame();
	}
	...
	public static void main(String[] args) {
		...
		javax.swing.SwingUtilities.invokeLater(new Runnable() {
	         public void run() {
				...
				// Use this method to add instance to the game with frame Variable
	...
	public void paintComponent(Graphics g) {
		...
		if (currentState == GameState.Playing) {          
			...
			if (currentPlayer == Player.Cross) {   
				...
				// Display a message when "X" won the game
				statusBar.setForeground(Color.RED);          
				statusBar.setText("'X' Won! Click to play again.");       
			} else if (currentState == GameState.Nought_Won) {          
				// Display a message when "O" won the game
		...
		public void initGame() {
			...
			// Set the game and player status when the game starts
		...
		public void updateGame(Player thePlayer, int row, int col) {
			...
			if(board.hasWon(thePlayer, row, col)) {
				...
				// Check the game status when one of the player won the game
